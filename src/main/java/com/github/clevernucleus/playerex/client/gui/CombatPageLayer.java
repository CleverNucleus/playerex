...
public class CombatPageLayer extends PageLayer {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		this.textRenderer.draw(matrices, (new TranslatableText("playerex.gui.page.combat.text.melee")).formatted(Formatting.DARK_GRAY), (this.x + 21) / scaleX.get(), (this.y + 26) / scaleY.get(), 4210752);
		this.textRenderer.draw(matrices, (new TranslatableText("playerex.gui.page.combat.text.defense")).formatted(Formatting.DARK_GRAY), (this.x + 21) / scaleX.get(), (this.y + 92) / scaleY.get(), 4210752);
		this.textRenderer.draw(matrices, (new TranslatableText("playerex.gui.page.combat.text.ranged")).formatted(Formatting.DARK_GRAY), (this.x + 105) / scaleX.get(), (this.y + 26) / scaleY.get(), 4210752);
	...
	static {
		COMPONENTS.add(RenderComponent.of(() -> EntityAttributes.GENERIC_ATTACK_SPEED, value -> {
			return new TranslatableText("playerex.gui.page.combat.text.attack_speed", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		}, value -> {
		...
		COMPONENTS.add(RenderComponent.of(() -> EntityAttributes.GENERIC_ATTACK_DAMAGE, value -> {
			return new TranslatableText("playerex.gui.page.combat.text.attack_damage", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.MELEE_CRIT_DAMAGE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.melee_crit_damage", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.MELEE_CRIT_CHANCE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.melee_crit_chance", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(() -> EntityAttributes.GENERIC_ARMOR, value -> {
			return new TranslatableText("playerex.gui.page.combat.text.armor", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(() -> EntityAttributes.GENERIC_ARMOR_TOUGHNESS, value -> {
			return new TranslatableText("playerex.gui.page.combat.text.armor_toughness", ClientUtil.FORMATTING_2.format(value)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(() -> EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.knockback_resistance", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.EVASION, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.evasion", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.RANGED_DAMAGE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.ranged_damage", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.RANGED_CRIT_DAMAGE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.ranged_crit_damage", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.RANGED_CRIT_CHANCE, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.ranged_crit_chance", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.ATTACK_RANGE, value -> {
			return new TranslatableText("playerex.gui.page.combat.text.attack_range", ClientUtil.FORMATTING_2.format(3.0F + value)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.LIFESTEAL, value -> {
			...
			return new TranslatableText("playerex.gui.page.combat.text.lifesteal", ClientUtil.FORMATTING_2.format(disp)).formatted(Formatting.DARK_GRAY);
		}, value -> {
			List<Text> tooltip = new ArrayList<Text>();
