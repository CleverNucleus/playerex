...
public final class ModifierJsonManager implements SimpleSynchronousResourceReloadListener {
	...
	public final Map<Identifier, UUID> cache;
	public final Map<Identifier, UUID> modifiers;
	
	public ModifierJsonManager() {
		this.cache = new HashMap<Identifier, UUID>();
		this.modifiers = new HashMap<Identifier, UUID>();
	}
	
	public void load() {
		this.modifiers.clear();
		this.modifiers.putAll(this.cache);
		this.cache.clear();
	}
