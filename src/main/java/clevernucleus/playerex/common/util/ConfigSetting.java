...
public class ConfigSetting {
	...
	public static class Client {
		...
		public Client(ForgeConfigSpec.Builder par0) {
			...
			this.enableGui = par0.comment("Set to false to disable the custom gui.").translation("config.client.enablegui").define("enableGui", true);
	...
	public static class Common {
		...
		public Common(ForgeConfigSpec.Builder par0) {
			...
			this.intelligence = par0
					...
					.translation("config.common.intelligence")
					.worldRestart()
